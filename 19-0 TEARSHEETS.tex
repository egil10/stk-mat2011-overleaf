\subsection{Tearsheets}\label{sec:apx-tearsheets}

The three tables below provide a self-contained quantitative tearsheet for each pair construction, broken out into one sub-table per monthly episode (August 2024, December 2024, April 2025) and stacked vertically. Each sub-table reports return, risk, risk-adjusted performance, trading activity, and distributional diagnostics for Buy-and-Hold (BH), the baseline cointegration strategy (BL), the binary AR-gated strategy (AR), and the continuous MS-AR threshold strategy (MS), with one pair per page.

The five blocks read as follows. The Return block reports the realised cumulative PnL in basis points over the episode (Total Return), its annualised counterpart (Annual Return, computed as $\text{bps}\times T_{\text{ann}}/T_{\text{episode}}$), and the best/worst monthly values; with only one month per episode, the best and worst columns coincide with the total and the ``positive months'' column is $0\%$ or $100\%$. The Risk block reports annualised volatility $\sigma_{\mathrm{ann}}$ of \eqref{eq:statmetrics}, the maximum drawdown $\mathrm{MDD}$ and its duration in bars, the Ulcer index $\mathrm{UI}$ of \eqref{eq:drawdown}, and the $95\%$ Value-at-Risk and Conditional VaR of \eqref{eq:varcvar}. The Risk-adj.\ block reports the Sharpe, Sortino, and Calmar ratios of \eqref{eq:ratios}, together with the trade-level Profit Factor (sum of winning trades divided by absolute sum of losing trades), Payoff Ratio (average win divided by average loss), and a Tail Ratio (the ratio of the $95$th to the absolute $5$th percentile of returns). The Trading block reports the number of round-trip trades, the win rate, the market exposure (fraction of bars with a non-zero position), and the average winning and losing trade in basis points. The Distr.\ block reports the per-bar skewness $\mathcal{S}$ and kurtosis $\mathcal{K}$ of \eqref{eq:statmetrics}, both of which are large in magnitude under the conditionally heteroskedastic, heavy-tailed return distribution discussed in Section~\ref{sec:result-pairdiag}. A dash in any cell indicates an undefined or numerically unstable statistic, typically because the strategy held no position or had too few trades to estimate the corresponding ratio.
...
\caption{AUD/USD--NZD/USD strategy tearsheet by monthly episode.}
...
\toprule
\textbf{Block} & \textbf{Month} & \textbf{Metric} 
& \textbf{BH} & \textbf{BL} & \textbf{AR} & \textbf{MS} \\
\midrule

\textbf{Return} 
& Aug. 2024 & Total Return (bps)        & -45.84  & -966.47   & -179.31  & -206.06 \\
...
\textbf{Risk}
& Aug. 2024 & Annual Volatility (bps)   & 554.99  & 360.20    & 120.07   & 181.98 \\
...
& Dec. 2024 & Annual Volatility (bps)   & 356.59  & 264.79    & 80.61    & 109.32 \\
...
& Apr. 2025 & Annual Volatility (bps)   & 743.57   & 541.55    & 225.04    & 252.92 \\
...
\textbf{Risk-adj.}
& Aug. 2024 & Sharpe Ratio              & -1.04   & -33.79    & -18.81   & -14.26 \\
...
& Dec. 2024 & Sharpe Ratio              & -1.39   & -36.93    & -21.36   & -18.21 \\
...
& Apr. 2025 & Sharpe Ratio              & 2.63     & -58.64    & -36.50    & -36.42 \\
...
\textbf{Trading}
& Aug. 2024 & Number of Trades          & 0       & 193       & 39       & 45 \\
...
\textbf{Distr.}
& Aug. 2024 & Skewness                  & 0.56    & -3.15     & -2.65    & 0.73 \\
...
\centering
\captionsetup{font=footnotesize}
\caption{EUR/NOK--EUR/SEK strategy tearsheet by monthly episode.}
...
\textbf{Return}
& Aug. 2024 & Total Return (bps)        & -148.51   & -6277.42   & -1816.72   & -2490.51 \\
...
\textbf{Risk}
& Aug. 2024 & Annual Volatility (bps)   & 904.87    & 1226.06    & 501.14     & 836.51 \\
...
& Dec. 2024 & Annual Volatility (bps)   & 634.41   & 813.82     & 343.78     & 532.97 \\
...
& Apr. 2025 & Annual Volatility (bps)   & 1508.79  & 1988.38     & 973.31      & 1143.00 \\
...
\textbf{Risk-adj.}
& Aug. 2024 & Sharpe Ratio              & -2.07     & -64.49     & -45.66     & -37.50 \\
...
& Dec. 2024 & Sharpe Ratio              & 1.20     & -69.24     & -58.36     & -48.94 \\
...
& Apr. 2025 & Sharpe Ratio              & 4.41     & -126.09     & -104.86     & -104.54 \\
...
\textbf{Trading}
& Aug. 2024 & Number of Trades          & 0         & 606        & 137        & 158 \\
...
\textbf{Distr.}
& Aug. 2024 & Skewness                  & 0.21      & -13.00     & -15.75     & -22.55 \\
...
\centering
\captionsetup{font=footnotesize}
\caption{GBP/USD--EUR/USD strategy tearsheet by monthly episode.}
...
\textbf{Return}
& Aug. 2024 & Total Return (bps)        & 65.09    & -396.06    & -48.60   & -60.14 \\
...
\textbf{Risk}
& Aug. 2024 & Annual Volatility (bps)   & 497.41   & 289.35     & 103.71   & 130.86 \\
...
& Dec. 2024 & Annual Volatility (bps)   & 444.49   & 282.61     & 71.07    & 103.73 \\
...
& Apr. 2025 & Annual Volatility (bps)   & 644.21   & 416.02     & 135.39    & 174.93 \\
...
\textbf{Risk-adj.}
& Aug. 2024 & Sharpe Ratio              & 1.65     & -17.24     & -5.90    & -5.79 \\
...
& Dec. 2024 & Sharpe Ratio              & 0.71     & -32.55     & -12.34   & -9.20 \\
...
& Apr. 2025 & Sharpe Ratio              & 0.31     & -45.69     & -32.62    & -29.23 \\
...
\textbf{Trading}
& Aug. 2024 & Number of Trades          & 0        & 281        & 79       & 83 \\
...
\textbf{Distr.}
& Aug. 2024 & Skewness                  & -0.01    & -0.29      & -0.49    & 0.18 \\
