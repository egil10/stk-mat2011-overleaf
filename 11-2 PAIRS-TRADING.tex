...
This section defines the baseline strategy as a self-contained pairs-trading rule \parencite{gatev2006pairs,vidyamurthy2004pairs}; the regime-aware extensions of Section~\ref{sec:regimemodels} keep its entry direction and only modify when it is allowed to trade.
